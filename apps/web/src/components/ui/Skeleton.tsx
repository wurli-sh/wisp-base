...
export function GiftCardSkeleton({ className }: { className?: string }) {
  return (
    <div
      className={cn("relative z-0 mx-auto w-full max-w-[420px]", className)}
      role="status"
      aria-busy="true"
      aria-label="Loading gift"
    >
...
/** Wisp send form: stock picker + amount chips + recipient. */
  ...
  return (
    ...
    >
      <div className="radius-surface overflow-hidden border border-border/80 bg-card p-2 shadow-card">
        <div className="radius-surface-inner space-y-4 border border-brand/15 bg-brand-mist px-6 py-6 sm:px-8 sm:py-7">
          <div className="grid grid-cols-3 gap-2">
            <Skeleton className="radius-surface-inner h-24 w-full" />
            <Skeleton className="radius-surface-inner h-24 w-full" />
            <Skeleton className="radius-surface-inner h-24 w-full" />
          </div>
...
export function FaucetPageSkeleton() {
  return (
    <div
      ...
      role="status"
      aria-busy="true"
      aria-label="Loading faucet"
    >
      <PageHeaderSkeleton titleW="w-28" subW="w-72" />
    ...
    >
      <div className="relative">
        <div className="flex justify-center">
          <div className="inline-flex gap-1 rounded-md border border-border/80 bg-muted/60 p-1">
            <Skeleton className="radius-control h-10 w-[5.5rem]" />
